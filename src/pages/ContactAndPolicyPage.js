      ...
      <PageContainer maxWidth="md">
        ...
        >
          ...
          >
            ...
            <Typography variant="body1" paragraph>
              הסכם ומדיניות זו חלה על האופן שבו מפעיל האתר אוסף, עושה שימוש, מחזיק וחושפת מידע שנאסף מהמשתמשים והצרכנים (ולהלן בלשון יחיד: “משתמש” או “מזמין” באתר) באתר Triroars.co.il (להלן: “האתר” או “המפעילה”). הסכם מדיניות פרטיות זו חלה על האתר ועל כל המוצרים והשירותים המוצעים בו על ידי איילון גרופר.
            </Typography>
            <Typography variant="body1" paragraph>
